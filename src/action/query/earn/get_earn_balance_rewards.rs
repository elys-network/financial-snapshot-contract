...
pub fn get_earn_balance_rewards(deps: Deps<ElysQuery>, address: String, asset: String) -> Result<GetBalanceResp, ContractError> {
    let ret = BALANCE_REWARD.may_load(deps.storage, &address);
