...
pub fn get_earn_balance_vesting(deps: Deps<ElysQuery>, address: String, asset: String) -> Result<GetBalanceResp, ContractError> {
    let ret = BALANCE_VESTING.may_load(deps.storage, &address);
