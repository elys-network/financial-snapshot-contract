...
pub fn get_earn_balance_available(deps: Deps<ElysQuery>, address: String, asset: String) -> Result<GetBalanceResp, ContractError> {
    let ret = BALANCE_AVAILABLE.may_load(deps.storage, &address);
