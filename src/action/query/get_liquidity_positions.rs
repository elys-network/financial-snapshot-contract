use super::*;
use crate::{bindings::query::ElysQuery, msg::query_resp::GetLiquidityPositionsResp};

pub fn get_liquidity_positions(deps: Deps<ElysQuery>) -> Result<GetLiquidityPositionsResp, ContractError> {
